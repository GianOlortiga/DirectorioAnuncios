<script>
    ...
    function archivo2(evt) {
            ...
            document.getElementById("list2").innerHTML = ['<div id="limpiar2"><img id="img2" class="thumb-min fade" src="', e.target.result,'" title="', escape(theFile.name), '"/></div><div class="files-2-min"><input type="button" class="files-a button-img" onClick="limpiar2();">'].join('');
                        };
                    })(f);
    ...
    function archivo3(evt) {
            ...
            reader.onload = (function(theFile) {
            	return function(e) {
               // Insertamos la imagen
            document.getElementById("list3").innerHTML = ['<div id="limpiar3"><img id="img3" class="thumb-min fade" src="', e.target.result,'" title="', escape(theFile.name), '"/></div><div class="files-2-min"><input type="button" class="files-a button-img" onClick="limpiar3();">'].join('');
                        };
                    })(f);
